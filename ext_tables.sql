...
CREATE TABLE tx_sfeventmgt_domain_model_event (
	...
	registration_options int(11) unsigned DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_sfeventmgt_domain_model_registrationoption'
#
CREATE TABLE tx_sfeventmgt_domain_model_registrationoption (
	...
	price double(11,2) DEFAULT '0.00' NOT NULL,
	price_options int(11) unsigned DEFAULT '0' NOT NULL,
	show_amount tinyint(4) unsigned DEFAULT '0' NOT NULL,
	amount_label varchar(255) DEFAULT '' NOT NULL,
	amount_max int(11) DEFAULT '1' NOT NULL,
	show_amount_input tinyint(4) unsigned DEFAULT '0' NOT NULL,
	amount_input_label varchar(255) DEFAULT '' NOT NULL,
	event int(11) unsigned DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_sfeventmgt_domain_model_registrationoptionprice'
#
CREATE TABLE tx_sfeventmgt_domain_model_registrationoptionprice (
	...
	price double(11,2) DEFAULT '0.00' NOT NULL,
	valid_until int(11) DEFAULT '0' NOT NULL,
	registration_option int(11) unsigned DEFAULT '0' NOT NULL,
	fe_group varchar(100) DEFAULT '0' NOT NULL,
